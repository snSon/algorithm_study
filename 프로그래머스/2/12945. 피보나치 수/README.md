...
## 피드백
피보나치 연산을 수행하는 과정에서 마지막에 %1234567을 수행하면 틀린다.
반복문을 수행하는 과정에서 long long 타입의 max값도 넘어버리므로 중간 과정에서 계속 %1234567을 수행해야 한다.

[문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/12945) 

### 성능 요약

메모리: 4.41 MB, 시간: 0.34 ms
